...
# Desenhe o resultado da inserção dessas chaves (na ordem dada)
# em uma árvore rubro-negra inicialmente vazia.
# (Aqui fazemos a inserção e imprimimos a árvore resultante)
